(function() {
  ...
  function captureLog(level, args) {
    ...
    try {
      ...
      // Silent failure for postMessage errors
    }
  ...
  window.addEventListener('error', function(event) {
    captureLog('error', [`Uncaught Error: ${event.error?.message || event.message}`, event.error || 'No error object']);
  });
